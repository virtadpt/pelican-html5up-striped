/* PrismJS 1.22.0
https://prismjs.com/download.html#themes=prism-tomorrow&languages=clike+asm6502+bash+basic+batch+git+go+icon+ignore+inform7+jq+json+json5+jsonp+nginx+python+regex+ruby+shell-session+sql+vim&plugins=command-line+toolbar+copy-to-clipboard+download-button */
